...
#Since Bagging Trees is basically making thousands of trees and averaging their results,
#the chunk code for doing my bagging cross-validation analysis had more than 220MB, so it was impossible
#to upload to github.

#so I just copied the results here and posted them as returning code.if you are interested you can check #the R markdown file "MachineLearningHuge.Rmd" in this github repo,and you will get results without this #"by-hand" input
```
...
##Summary of sample sizes: 9421, 9420, 9422, 9421, 9420, 9422, ... 
##Resampling results

##  Accuracy   Kappa      Accuracy SD  Kappa SD   
##  0.9966879  0.9958105  0.001246294  0.001576505
```
...
#so I copied the true results obtained by hand in a new vector and just added them to the results vector
#with the other models results.

#if you are interested you can check the R markdown file "MachineLearningHuge.Rmd" in this github repo,
#and you will get results without this "by-hand" input

results<-resamples(list(Boosted = Boosted, RandFor = RandFor, SVM = SVM))
Baggin<-data.frame(c("Fold1.Rep1", "Fold1.Rep2", "Fold1.Rep3", "Fold2.Rep1", "Fold2.Rep2", "Fold2.Rep3", "Fold3.Rep1", "Fold3.Rep2","Fold3.Rep3", "Fold4.Rep1", "Fold4.Rep2", "Fold4.Rep3", "Fold5.Rep1", "Fold5.Rep2", "Fold5.Rep3"), c(0.9970276, 0.9974511, 0.9978778, 0.9970289 ,0.9978778, 0.9970276 ,0.9966015, 0.9966044, 0.9970289, 0.9966030,0.9970289, 0.9953271, 0.9974533, 0.9927782, 0.9966030),c(0.9962406, 0.9967761, 0.9973155, 0.9962418, 0.9973155, 0.9962397, 0.9957017, 0.9957048, 0.9962419, 0.9957029,0.9962421, 0.9940886, 0.9967787, 0.9908651, 0.9957031))
colnames(Baggin)<-c("Resample","Bagging~Accuracy","Bagging~Kappa")
results$values<-left_join(Baggin,results$values)
results$models<-c("Bagging", results$models)
```
